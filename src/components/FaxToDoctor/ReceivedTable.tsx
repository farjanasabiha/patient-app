      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="bg-white rounded-[10px] flex flex-col border border-stone-300">
          ...
          <div className="bg-white rounded-t-[10px] flex border-b border-stone-300">
            ...
            <TableCell width="w-40">
              <TableText variant="semibold">Faxed From</TableText>
            </TableCell>
            <TableCell width="w-42">
              <TableText variant="semibold">Faxed From Doctor</TableText>
            </TableCell>
            <TableCell width="w-40">
              <TableText variant="semibold">Received Date</TableText>
            </TableCell>
          </div>
