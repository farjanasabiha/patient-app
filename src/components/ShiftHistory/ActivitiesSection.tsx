...
const ActivitiesSection: React.FC<ActivitiesSectionProps> = ({ days }) => {
  // Items for Ambulation
  const ambulationItems = [
    "Walking",
    "Walker",
    "Rollator",
    "Cane",
  ...
  return (
    <CollapsibleSection
      title="Activities / Assistive Devices"
      className="mt-3"
    >
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            <div className="flex flex-col bg-white rounded-[10px] overflow-hidden border border-[#C7C7CC]">
              ...
              {ambulationItems.map((item, index) => (
                <div
                  key={item}
                  className={`flex flex-row w-full ${
                    index !== ambulationItems.length - 1
