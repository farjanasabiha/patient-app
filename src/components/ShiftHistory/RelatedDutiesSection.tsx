...
interface RelatedDutiesSectionProps {
  days: string[];
}

const RelatedDutiesSection: React.FC<RelatedDutiesSectionProps> = ({
  days,
}) => {
  ...
  return (
    <CollapsibleSection title="Related Duties" className="mt-3">
...
export default RelatedDutiesSection;
