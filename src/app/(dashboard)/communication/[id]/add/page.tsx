...
import { CommunicationForm } from "@/components/Communication/forms/CommunicationForm";
...
const AddCommunicationPage = () => {
  ...
  return (
    <div className="bg-white rounded-md">
      <CommunicationForm patientId={patientId} patientName={patient.name} />
    </div>
  );
};

export default AddCommunicationPage;
